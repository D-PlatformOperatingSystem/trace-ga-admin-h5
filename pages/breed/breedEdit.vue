<template>
	<view class="body">
		...
		<view class="infro-ng">
			<text class="">{{$t('breed.IncDate')}}：</text>
			<text>{{detail.plantDate}}</text>
		</view>
		<view class="batch-infor">
			<view class="infro-ng">
				<text class="">{{$t('public.farm')}}：</text>
				<text>{{detail.farmId_dictText}}</text>
			</view>
			<view class="infro-ng">
				<text class="">{{$t('public.parcel')}}：</text>
		...
		<view class="batch-infor">
			...
			<view class="infro-ng">
				<text class="">{{$t('breed.CulProject')}}：</text>
				<text>{{detail.plantTypeId_dictText}}</text>
			</view>
			<view class="infro-ng">
				<text class="">{{$t('public.liable')}}：</text>
				<text>{{detail.employeeId_dictText}}</text>
			</view>
		</view>
		<view class="infro-upload">
			<view class="title">{{$t('breed.CulPic')}}：</view>
			<view class="upload-front">
				<image :src="imageUrl+detail.img" mode=""></image>
			</view>
			<view class="upload-front">
				<image :src="imageUrl+detail.imgAfter" mode=""></image>
			</view>
		</view>
	</view>
</template>
...
<script>
	export default {
		data() {
			return {
				detail: [],
				imageUrl: 'https://trace.domchain.io/web_files_server/upload/'
			}
		},
		onLoad(option) {
