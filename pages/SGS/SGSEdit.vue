	...
	<view class="body">
		<view class="fixed">
			<cu-custom :isBack="true" bgColor="text-white">
				<block slot="content">SGS</block>
			</cu-custom>
		</view>
		<view class="infro-ng">
			<text class="">{{$t('SGS.cerDate')}}：</text>
			<text>{{detail.issueTime}}</text>
		</view>
		<view class="batch">
			<text>{{$t('SGS.ExpTime')}}：</text>
			<text>{{detail.issueExpiration}}</text>
		</view>
		...
		<view class="infro-upload">
			...
			<view class="upload-front">
				<image :src="imageUrl+detail.sgsImg" mode=""></image>
			</view>
		</view>
	</view>
</template>
